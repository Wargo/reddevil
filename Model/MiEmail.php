		...
		'MiEmail.Email' => array(
			...
			'config' => array(
				//'port'=> 465,
			 	...
			 	//'host' => 'mail.nabucai.com',
			 	'timeout' => 30,
			 	//'username' => 'info@nabucai.com',
			 	//'username' => 'info@correos.nabucai.com',
			 	//'password' => 'artvisual',
			 	//'password' => 'nabucai2011',
			 	//'auth' => true,
				'protocol' => 1,
			),
			'delivery' => 'smtp',
 ...
 */
	...
	function send_email($type = null, $data = null) {
		...
		$this->create();
		if(empty($data['from'])) {
			//$data['from'] = 'Nabucai <' . Configure::read('ADMIN_EMAIL') . '>';
			$data['from'] = Configure::read('Site.email');
		}
	 	/*	
