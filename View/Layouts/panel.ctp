	...
	<div id="container">
		<div id="header">
			...
			<ul class="menu">
				...
				<li><?php echo $this->Html->link(__('Fondos', true), array('admin' => true, 'controller' => 'wallpapers', 'action' => 'index'), array('class' => $this->params['controller'] == 'wallpapers' ? 'selected' : '')); ?></li>
