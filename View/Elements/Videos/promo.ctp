...
echo '<div class="link_promo">';
	echo $this->Html->link($this->Html->image('bg/banner.jpg'), 'http://www.reddevilx.com/trailer/pablo-ferrari-y-jakeline-teen-en-la-caja-de-musica', array('escape' => false));
