<div class="menu clearfix">
	...
	<ul class="menu_buttons">
		...
		<li><?php echo $this->Html->link(__('Series'), array('controller' => 'videos', 'action' => 'sites'), array('class' => $this->params['controller'] == 'videos' && $this->params['action'] == 'sites' ? 'selected disabled' : 'disabled', 'title' => __('Webcams'))); ?></li>
		<?php
